      ...
      {editMode && (
        <>
          ...
          <div 
            ...
            className="absolute bottom-[95px] right-12 w-[620px] h-[84px] z-[60] cursor-pointer hover:outline hover:outline-2 hover:outline-dashed hover:outline-[#9D5CFF] bg-[#9D5CFF]/5 transition-all group rounded-xl"
